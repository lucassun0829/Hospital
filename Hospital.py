...
print(f"Phone {list_phone}")
print("Break")
print(f"Mail {list_mail}")
print("Break")
print(f"Form {list_form}")
print("Break")
print(f"Text {list_text}")
print("Break")
print(f"tty {list_tty}")
print("Break")
print(f"Relay {list_relay}")
print("Break")
print(f"Bad Websites {bad_websites}")
print("Break")

# print(f"Phone name {list_phone_name}")
# print("Break")
# print(f"Mail name {list_mail_name}")
# print("Break")
# print(f"Form name {list_form_name}")
# print("Break")
# print(f"Text name {list_text_name}")
# print("Break")
# print(f"tty name {list_tty_name}")
# print("Break")
# print(f"Relay name {list_relay_name}")
# print("Break")
# print(f"Bad Websites name {bad_websites_name}")
# print("Break")

# print(f"Good Phone {good_list_phone}")
# print("Break")
# print(f"Good Mail {good_list_mail}")
# print("Break")
# print(f"Good Form {good_list_form}")
# print("Break")
# print(f"Good Text {good_list_text}")
# print("Break")
# print(f"Good tty {good_list_tty}")
# print("Break")
# print(f"Good Relay {good_list_relay}")
# print("Break")

# print(f"Good Phone name {good_list_phone_name}")
# print("Break")
# print(f"Good Mail name {good_list_mail_name}")
# print("Break")
# print(f"Good Form name {good_list_form_name}")
# print("Break")
# print(f"Good Text name {good_list_text_name}")
# print("Break")
# print(f"Good tty name {good_list_tty_name}")
# print("Break")
# print(f"Good Relay name {good_list_relay_name}")
# print("Break")
...
# print("Break")
# print(f"Cant Decode {cannot_decode}")
# print("Break")
# print(f"Java Script {javascript}")
# print("Break")
